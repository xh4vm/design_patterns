...
> Information taken from [resources](https://refactoring.guru/design-patterns/singleton)
...
The Singleton pattern solves two problems at the same time, violating the __Single Responsibility Principle__:
...
More informations on [resource](https://refactoring.guru/design-patterns/singleton)